...
Ads.prototype.contentEnded = function() {
  ...
  //pause video
    application.pauseForAd();
	
		//hide  videoPlayer  show  game
    document.getElementById('videoplayer').style.left="-1000px";
	   
 containerVideoGame.style.left="0px";
	   var  startgame1 = setInterval(function () {
...
Ads.prototype.processAdsManager_ = function(adsManager) {
  ...
  adsManager.addEventListener(
	...
	adsManager.addEventListener(
      google.ima.AdErrorEvent.Type.FIRST_QUARTILE,
      this.onContentFirstRequested_,
      false,
      this);
...
Ads.prototype.onContentFirstRequested_ = function(adErrorEvent) {
//FIRST_QUARTILE 
  debugger
...
Ads.prototype.onAdEvent_ = function(adEvent) {
  ...
  if (adEvent.type == google.ima.AdEvent.Type.CLICK) {
   ...
   if (adEvent.type == google.ima.AdEvent.Type.FIRST_QUARTILE) {
   
	
	console.log("one  FIRST_QUARTILE");
  }
