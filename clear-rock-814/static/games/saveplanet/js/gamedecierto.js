...
var GameWorld = new function()
{
  ...
  var     barra= 60;
    // Game Constants
    var DEFAULT_WIDTH                 = 1000;// 1000;//
    var DEFAULT_HEIGHT                 = 1100;//1100;
    var FRAMERATE                     = 60;
    var CCD_QUALITY                 = 8;
    var DIRTY_PADDING                 = 40;//40
    ...
    var score                         = 0;
    var assetCount                    = 0;
    var blastRadius                    = 0;                                      //gameBackground.jpgbg1.png
    var assets                        = [{id:'background', src:'./images/estrellas.gif'},//dgameBackground.jpgecierto.gifdesierto/uracan/tarde/lluvia
                                       {id:'boss', src:'./images/nave10.gif'},//gameBosso nave7 nave10
                                       {id:'player', src:'./images/gamePlayer.png'},//gamePlayer.png
                                       {id:'sprite', src:'./images/gameSprite.png'}];
    ...
    this.initialize = function(){
        ...
        if (canvas && canvas.getContext) {
            ...
            player = new Player(world.width *.5 + 5, world.height + worldYOffset + 130);
            
            // Force an initial resize to make sure the UI is sized correctly
            windowResizeHandler();
            
            // Work out where our last defensive shield is
            lastDefense = new LastDefense(world.width * .5 + 5, world.height + worldYOffset + 130);
    ...
    function changeState( newState ) {
        ...
        switch (state) {
            ...
            case STATE_PLAYING:
                ...
                sound1.src="images/soundgame2.ogg";//soundmenu  // soundgame
    ...
    this.nextLevel = function()
    {
        ...
        //if(level === 1 || level === 2 || level === 3 || level === 4 )
            ...
            /*if(level >=1 ){
             sound1.src="images/soundgame2.ogg";
                sound1.play();
        ...
        if(level >= 4 )
        {
          ...
          bossDiv.style.top="80%";
             btnNextlevel.style.top="-30%";
    ...
    this.playCurrentLevelTrack = function() {
        ...
        switch(level)
        {
                ...
                case 0: sound1.src="images/soundgame2.ogg";
                sound1.play();
                break;
                
            case 1: sound1.src="images/sound2.mp3";
                sound1.play();
                break;
            
            case 2: sound1.src="images/soundgame2.ogg";
                sound1.play();
                break;
                
                case 3: sound1.src="images/sound2.mp3";
                sound1.play();
                break;
            case 4: sound1.src="images/soundgame2.ogg";
                sound1.play();
                break;
    ...
    var GameUI = new function(){
        ...
        this.elements.logo2fin = $('#logo2fin');    
            this.elements.levelIndicator = $('#level-indicator');
            this.elements.startButton = $('#start-button');//start-button
            this.elements.muteButton = $('#mute-button');
            this.elements.muteButton2 = $('#mute-button2');
            
            this.elements.pauseButton = $('#pause-button');
        this.elements.pauseButton2 = $('#pause-button2');
        ...
        this.elements.btnMisil = $('#btnMisil');//#btnMisil
        
        this.elements.hud4 = $('#hud4');
            
            this.elements.cursor = $('#cursor');
        this.elements.btnNextlevel = $('#btnNextlevel');
        this.elements.player1 = $('#player1');
        this.elements.btntw = $('#btnTw');
        this.elements.transportelevel = $('#transportelevel');
        
        
        
        // Listen for interaction with the mute button
            this.elements.btnMisil.click( function() { 
            ...
            // Listen for interaction with the mute button
            this.elements.btnNextlevel.click( function() { 
               //paused= false;
              
              logo.style.top="-130%";
                btnNextlevel.style.top="-130%";
                
                btnTw.style.top="-130%";
                transportelevel.style.display="block";
                    
                
                
             var introclevel = setInterval(function () {
              
                //location.href="leveldecierto.html";
            transportelevel.style.left="0px";
                clearInterval(introclevel);
            }, 500);
             
              var introclevel2 = setInterval(function () {
              
                //location.href="leveldecierto.html";
            transportelevel.style.top="50%";
        
                clearInterval(introclevel2);
            }, 2500);
              
               var introclevel3 = setInterval(function () {
              
                //location.href="leveldecierto.html";
            transportelevel.style.top="-150%";
            
                clearInterval(introclevel3);
            }, 3500);
               
                var introclevel4 = setInterval(function () {
              
            location.href="levelguerra3.html";
        
            
                clearInterval(introclevel4);
            }, 4500);
            ...
            this.elements.startButton.click( function() { 
                ...
                barravida.style.height =barra+"%";
                //$('start-button').style.display="none";
                player1.style.display = "none";
                //bjar el player
                player1.style.height ="30%";
                player1.style.top ="75%";
            ...
            this.elements.logo.click( function() { 
                go.play();
                startGame(); 
                barravida.style.height =barra+"%";
                //bjar el player
                ...
                pantagameover.style.display = "none";
                        pantagameover0.style.display = "none";
            ...
            this.elements.logo2fin.click( function() { 
            ...
            this.elements.btntw.click( function() { 
                
                             window.open("http://twitter.com/home?status="+escape("!winner  level 2  the game SAVE PLANET   my score is  "+score+"!"));
            ...
            this.showElement( this.elements.muteButton2 );
...
//            });
        ...
        this.togglePauseState = function() {
            if( this.elements.pauseButton2.hasClass( 'resume' ) ) {
                paused = false;
            }
            else {
                paused = true;
            ...
            this.elements.pauseButton2.toggleClass('resume');
        }
        ...
        this.pauseButtonStateOn = function() {
            this.elements.pauseButton2.addClass('resume');
        }
        ...
        this.pauseButtonStateOff = function() {
            this.elements.pauseButton2.removeClass('resume');
        }
        ...
        this.updateMuteState = function(){
            if( settings.soundEnabled ) {
                this.elements.muteButton2.removeClass( "sound-is-off" );
                //GameSound.send( GameSound.UNMUTE );
                  sound1.pause();
            }
            else {
                this.elements.muteButton2.addClass( "sound-is-off" );
                //GameSound.send( GameSound.MUTE );
                sound1.play();
            }
            
            this.elements.muteButton2.fadeIn(300);
        }
    ...
    function documentMouseMoveHandler(event)
    {
        ...
        if( playing && mouse.y > world.height * .5 && mouse.x > 0 && mouse.x < world.width)
        {
              ...
              player1.style.left = event.clientX+"px";
            if(isMac)
            {
    ...
    function documentTouchMoveHandler(event)
    {
        if(event.touches.length == 1) {
            ...
            player1.style.left =event.touches[0].pageX-100+"px";
    ...
    function windowResizeHandler()
    {
        ...
        bossDiv.style.top            = "0px"//cvy - worldYOffset + 'px';
        playerDiv.style.bottom        = cvy - worldYOffset + 'px';
        
        if(boss)
            boss.position.y            =-200; //-(worldYOffset + 80);//80
        player.position.y            =world.height + worldYOffset + 130;// world.height + worldYOffset + 90;
        
        // Work out where our last defensive shield is
        lastDefense = new LastDefense(world.width * .5 + 5, world.height + worldYOffset + 130);//90
    ...
    function loop()
    {
        ...
        if ( !paused ) {
            ...
            if (playing) {
                ...
                if(score > 100 )
                {
                 // hud1.style.left="30%";//alien
                hud2.style.left="50%";//nave ovni
                 ...
                 if(score > 20000 )
                {
                  ...
                  pantaactor1avioneta.style.display = "block";
                  ...
                  if(score > 40000 )
                {
                  ...
                  pantaactor1avioneta.style.display = "none";
                   ...
                   if(score > 58000 )
                {
                      ...
                      hud1.style.left="110%";//alien
                
                }
                
                //pausar juego mostrar level finish  y cambiar cancion 
                /* if(score > 60000 )
                {
                    ...
                    if(score > 68000 )
                {
                      ...
                      pantaactor1.style.left="0%";//alien
                    ...
                    if(score > 248000 )
                {
                    ...
                    if(score > 268000 && score < 279000 )
                {
                
                      btnMisil.style.left="80%";//helper
                   ...
                   if(score > 288000 )
                {
                      ...
                      pantaactor1.style.left="-110%";//alien
        ...
        for( var i = 0; i < boss.missiles.length; i++ )
        {
            ...
            else if (missile.floating)
            {
                ...
                if(missile.distanceTo({x:boss.position.x, y:boss.position.y}) < BOSS_RADIUS && missile.velocity.y < 0)
                {
                    ...
                    //al golpear el enemigo
                    stopdeath.play();
                    
                }
                
                // check for proximity to player checkForShieldIntersection(lastDefense.shieldPoints, missile, GameSound.PADDLE_BOUNCE);
                else if(distanceToPlayer < (PLAYER_RADIUS + 50) && missile.velocity.y > 0)
                {
                  
                      golpeshield.play();
                    if(playing)
                        checkForShieldIntersection(lastDefense.shieldPoints, missile);
                    ...
                    if(distanceToPlayer < PLAYER_RADIUS)
                    {
                        ...
                        if( playing )
                        {
                            ///GameWorld.sound(GameSound.MY_PLANET_HIT);checkForShieldIntersection(lastDefense.shieldPoints, missile, GameSound.PADDLE_BOUNCE);
                            //gameOver();
                          ...
                          document.getElementById('barravida').style.height = barra+"%";
                          
                          //alert("barra descontando"+ barra);
                          ...
                          if(barra === 0)
                          {
                           // paused = true;
                            ...
                            barra = 60;
                              pantagameover0.style.display = "block";
                            pantagameover.style.display = "block";
                          
                              gameOver();
                              
                              var introgameoverfin = setInterval(function () {
                              pantagameover0.style.display = "none";
                            logo2fin.style.display = "block";
                            
                            
                            clearInterval(introgameoverfin);
                                                   }, 4000);
                            ...
                            //nave8 elicopero vacano se ve bine
                            
                             logo.style.backgroundImage = "none";
                       logo.style.backgroundSize = "100% 100%,0px 0px ,auto,auto";
                        logo.style.backgroundImage = "url(images/nave10.gif)";
           ...
           pantabun.style.display = "none";
            clearInterval(introc28);
                         ...
                         var introc29 = setInterval(function () {
       
          // pantaactor1.style.display = "none";
            clearInterval(introc29);
        }, 2500);             
                ...
                else if(missile.position.y > (world.height * .5) - 10)
                {
                      ...
                      checkForShieldIntersection(player.shieldPoints, missile);
                }
            }
        }
    }
    ...
    function renderBoss()
    {
        ...
        for(var i = 0, len = boss.rings.length; i < len; i++)
        {
            ...
            var ringStep            = Math.PI * 2 / ring.missiles.length;
            context.globalAlpha        = .2 + (i/boss.rings.length) * .1;
