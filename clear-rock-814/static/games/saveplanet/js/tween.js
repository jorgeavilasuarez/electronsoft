...
TWEEN.Tween = function ( object ) {
	...
	this.onBeforeUpdate = function ( onBeforeUpdateFunction ) {

		_onBeforeUpdateFunction = onBeforeUpdateFunction;
		return this;
	...
	this.update = function ( time ) {
		...
		if ( _onBeforeUpdateFunction !== null ) {

			_onBeforeUpdateFunction.call( _object );
